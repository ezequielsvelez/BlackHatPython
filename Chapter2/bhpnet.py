...
def client_handle(client_socket):
    ...
    if len(upload_destination):
        ...
        try:
            ...
            success_msg = "Successfully saved file to %s\r\n" % upload_destination
            client_socket.send(success_msg.encode())
        except:
            failed_msg = "Failed to save file to %s\r\n" % upload_destination
            client_socket.send(failed_msg.encode())
...
def main():
    ...
    # execute commands, and drop a shell back depending
